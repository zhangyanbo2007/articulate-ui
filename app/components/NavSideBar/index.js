  ...
  render() {
    ...
    return (
      <aside id="side-nav">
        ...
        <div style={{textAlign: 'center', color: 'white', fontWeight: 'bolder', fontSize: 'larger'}}>With BotSharp</div>
        <nav>
          ...
          <ul className="bottom-nav">
            ...
            <li>
              <p className="built-by">Built with <a target="_blank" href="https://github.com/Oceania2018/BotSharp">BotSharp NLU</a>.</p>
            </li>
          </ul>}
        </nav>
      </aside>
